...
<div id="header">
    <div class="h_nav"> <a href="index.jsp"><div class="h_left"><img src="images/l.png" /></div></a>  会员登陆</div>
</div>
...
<div id="inner">
	...
	<div>
		...
		<div id="dl3" class="dl">
			<iframe width="100%" height="350px" src="reg_inner.jsp" name="tgjl_frame" frameborder="0"></iframe>
		 </div>
    </div>
