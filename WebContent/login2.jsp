...
<div id="inner">
    <div class="hyzl">
        <div class="hyzl_nav" id="hyzl_nav">
			...
			<div id="login3"  class="q_n_on f_l bodo_r"  style="width:33%;">
            	<li tab="dl3">普通登录</li>
			</div>
			<div id="login2" class="q_n_on f_l"  style="width:33%;">
            	<li tab="dl2">短信登陆</li>
			</div>
        </div>
    </div>
	...
	<div id="dl1" class="dl">
		 <form name="personal" method="post" action="afterregnewuser.jsp" onSubmit="return test()" target="cname">
			...
			<div class="input"> <img src="images/sj.png" /> <input name="sjtel" id="sjtel" type="text" class="inp_txt2" placeholder="输入手机号码" value="" />  <a href="javascript:void(0);" onclick="sendSms();"><div class="inp_yz">获取验证码</div></a>   </div>
		...
		<input type="hidden" name="url" value="<%=url%>"/>
			<div id="dl2" class="dl">
				<input type="hidden" id="goToUrl" name="goToUrl" value="index.jsp" />
				<div class="input"><img src="images/sj.png" /> <input name="sjtel" type="text" class="inp_txt2" placeholder="手机号码" value="<%=username %>" />  <a href="javascript:void(0);" onclick="sendSms();"><div class="inp_yz">获取校验码</div></a>   </div>
        		<div class="input"><img src="images/sr.png" /> <input name="verycode" type="text" class="inp_txt1" placeholder="填写校验码" /></div>
				<button class="btn tjan">立即登陆</button>
			</div>
		</form>
