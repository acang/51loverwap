...
<%
    ...
    if(bizaction.equals("01"))
    {
        if(loginUser == null)
        {
            out.println("<script language='javascript'>alert('您是游客，您的权限不够，请先注册或登陆！');</script>");
            out.println("<script langauge=javascript>location.href = '../reg.jsp?url=./bbs/"+url+"';</script>");
            return;
        }
