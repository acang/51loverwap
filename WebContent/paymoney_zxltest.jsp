...
<div id="inner">
    ...
    <div class="sjhy">
       <ul> 
        ...
        <ul> 
          <li><div class="sjhy_nav"> 白金豆 </div></li>
          <li> <div class="sjhy_tl">★</div> <div class="sjhy_tr">48小时内查看会员详细联系办法；</div> </li>
          <li> <div class="sjhy_tl">★</div> <div class="sjhy_tr">查看未验证会员1颗/位，查看已验证会员2颗/位；</div> </li>
          <li> <div class="sjhy_tl">★</div> <div class="sjhy_tr">100元=10颗，200元=20+10颗；</div> </li>
        </ul>
        <ul> 
          <li><div class="sjhy_nav"> VIP会员 </div></li>
          <li> <div class="sjhy_tl">★</div> <div class="sjhy_tr">普通会员的全部权限、首页推荐（附照）；</div> </li>
          <li> <div class="sjhy_tl">★</div> <div class="sjhy_tr">专享高级搜索，十六个条件精准查找全部会员；</div> </li>
        ...
        <ul> 
          ...
          <li><div class="sjhy_nav"> 收费标准 </div></li>
           <li> 
            ...
            <em id="select88"><div class="sihy"><div class="select" data-val="1998" data-id="261"><img src="images/dotin.png"/></div> 白金VIP会员（二年期） <span class="sihy-t"></span> 优惠价: <b>1998元 </b> </div></em>
            <em id="select77"><div class="sihy"><div class="select" data-val="1298" data-id="241"><img src="images/dotin.png"/></div>  白金VIP会员（一年期）<span class="sihy-t"> </span> 优惠价: <b>1298元 </b> </div></em>
            <em id="select66"><div class="sihy"><div class="select" data-val="798" data-id="221"><img src="images/dotin.png"/></div>  白金VIP会员（半年期） <span class="sihy-t">  </span> 优惠价: <b>798元 </b> </div></em>
            <em id="select33"><div class="sihy"><div class="select" data-val="698" data-id="322"><img src="images/dotin.png"/></div>  VIP会员（三年期） <span class="sihy-t"> </span> 优惠价: <b>598元 </b> </div></em>
