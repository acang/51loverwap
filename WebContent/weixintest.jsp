    ...
    <div class="sjhy">
       <ul> 
        ...
        <ul> 
          ...
          <li> <div class="sjhy_tl">★</div> <div class="sjhy_tr">可在留言区公开自己的联系方式。</div> </li>
          <li> <div class="sjhy_tl">★</div> <div class="sjhy_tr">白金豆:48小时内查看会员详细联系办法</div> </li>
          <li> <div class="sjhy_tl">&nbsp;</div> <div class="sjhy_tr">(未验证会员1颗/位，已验证2颗/位)</div> </li>
        </ul>
          ...
          <li><div class="sjhy_nav"> 收费标准 </div></li>
           <li> 
            ...
            <em id="select33"><div class="sihy"><div class="select" data-val="798" data-id="261"><img src="images/dotin.png"/></div> 三年 <span class="sihy-t"> <span class="sihy-txt">原价:1580元</span></span> / 优惠价: <b>798元 </b> </div></em>
            <em id="select22"><div class="sihy"><div class="select" data-val="598" data-id="241"><img src="images/dotin.png"/></div>  二年 <span class="sihy-t"> <span class="sihy-txt">原价:1280元</span> </span> / 优惠价: <b>598元 </b> </div></em>
            <em id="select11"><div class="sihy"><div class="select" data-val="398" data-id="221"><img src="images/dotin.png"/></div>  一年 <span class="sihy-t"> <span class="sihy-txt">原价:880元</span> </span> / 优惠价: <b>398元 </b> </div></em>
